                            ...
                            <div className="columns is-4 is-multiline is-desktop">
                                <div className="column is-half-desktop contact-tel has-text-centered-touch">
                                    <div className="is-clearfix">
                                        ...
                                        <Link to="https://wa.me/85269965240">
                                            <h5 className="contact-btn mt-4 py-4 pl-5 has-background-white is-size-6-mobile has-text-left-desktop"> <FontAwesomeIcon icon={faWhatsapp} className="ml-2 mr-5 mt-1 is-size-5" />立即查詢報價或細節</h5>
                                        </Link>
                                    </div> 
                                </div>
                                ...
                                <div className="column is-half-desktop has-text-centered-touch">
                                    <div className="is-clearfix">
                                        ...
                                        <Link to="/">
                                                <h5 className="contact-btn mt-4 py-4 pl-5 has-background-white is-size-6-mobile has-text-left-desktop"> <FontAwesomeIcon icon={faEnvelopeOpen} className="ml-2 mr-5 mt-1" />gsgaderning@yahoo.com</h5>
                                        </Link>
                                    </div>
                                </div>
